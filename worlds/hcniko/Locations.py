...
location_data_table: Dict[str, HereComesNikoLocationData] = {
    ...
    "Hairball City - Blippy Coin": HereComesNikoLocationData(region="Hairball City",id=base_id + 15, location_group="Blippy"),
    ...
    "Turbine Town - Blippy Coin": HereComesNikoLocationData(region="Turbine Town",id=base_id + 26, location_group="Blippy"),
    ...
    "Salmon Creek Forest - Blippy": HereComesNikoLocationData(region="Salmon Creek Forest",id=base_id + 32, location_group="Blippy"),
    ...
    "Salmon Creek Forest - Blippy Coin": HereComesNikoLocationData(region="Salmon Creek Forest",id=base_id + 42, location_group="Blippy"),
    ...
    "Public Pool - Blippy Coin": HereComesNikoLocationData(region="Public Pool",id=base_id + 47, location_group="Blippy"),
    ...
    "Bathhouse - Blippy Coin": HereComesNikoLocationData(region="Bathhouse",id=base_id + 67, location_group="Blippy"),
    # ~ Tadpole HQ
    ...
    "Tadpole HQ - Blippy Coin": HereComesNikoLocationData(region="Tadpole HQ",id=base_id + 74, location_group="Blippy"),
    ...
    # Letters
    "Home - Letter near Crane": HereComesNikoLocationData(region="Home",id=base_id + 80, location_group="Letter"),
    "Hairball City - Letter in a Tree": HereComesNikoLocationData(region="Hairball City",id=base_id + 81, location_group="Letter"),
    "Hairball City - Letter behind the Train": HereComesNikoLocationData(region="Hairball City",id=base_id + 82, location_group="Letter"),
    "Turbine Town - Letter behind Wind Dragon": HereComesNikoLocationData(region="Turbine Town",id=base_id + 83, location_group="Letter"),
    "Turbine Town - Letter on Shipping Container": HereComesNikoLocationData(region="Turbine Town",id=base_id + 84, location_group="Letter"),
    "Salmon Creek Forest - Letter inside locked Cave": HereComesNikoLocationData(region="Salmon Creek Forest",id=base_id + 85, location_group="Letter"),
    "Salmon Creek Forest - Letter in Secret of the Forest": HereComesNikoLocationData(region="Salmon Creek Forest",id=base_id + 86, location_group="Letter"),
    "Public Pool - Letter on Far Away Island Left": HereComesNikoLocationData(region="Public Pool",id=base_id + 87, location_group="Letter"),
    "Public Pool - Letter on Far Away Island Right": HereComesNikoLocationData(region="Public Pool",id=base_id + 88, location_group="Letter"),
    "Bathhouse - Letter behind Axolotl Family": HereComesNikoLocationData(region="Bathhouse",id=base_id + 89, location_group="Letter"),
    "Bathhouse - Letter behind Game Kid": HereComesNikoLocationData(region="Bathhouse",id=base_id + 90, location_group="Letter"),
