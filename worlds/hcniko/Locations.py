...
location_data_table: Dict[str, HereComesNikoLocationData] = {
    ...
    "Tadpole HQ - Skyscraper Ledge Above Elevator": HereComesNikoLocationData(region="Tadpole HQ",id=base_id + 250, location_group="Letter"),
    ...
    "Public Pool - Above Green Frog Statue": HereComesNikoLocationData(region="Public Pool",id=base_id + 96),
